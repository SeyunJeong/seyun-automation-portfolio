...
from modules.stock_data_api import StockDataAPI
from modules.data_processing import prepare_data
from config.config import SHEET_TAB, SPREADSHEET_ID, RANGE_WRITE, STOCK_DATA_API_KEY, CACHE
...
def main():
    ...
    api = StockDataAPI(STOCK_DATA_API_KEY)
