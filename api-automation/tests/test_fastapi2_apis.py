...
class TestFastAPI2:
    """FastAPI2 서버 API 테스트 클래스 - 시간 측정 포함"""
    ...
    def test_아이디어탭_관심그룹_토큰포함(self, api_client):
        ...
        # Given: 인증된 API 클라이언트
        url = api_client.get_fastapi2_url("/api/v2/interest/groups")
    ...
    def test_아이디어탭_스토리_ID정상기입(self, api_client):
        ...
        url = api_client.get_fastapi2_url(f"/api/v2/interest/stories/{group_id}")
    ...
    def test_아이디어탭_스토리_ID오기입(self, api_client):
        ...
        url = api_client.get_fastapi2_url(f"/api/v2/interest/stories/{invalid_story_id}")
    ...
    def test_아이디어탭_종목정보_ID정상기입(self, api_client):
        ...
        url = api_client.get_fastapi2_url(f"/api/v2/interest/{interest_id}/price")
        params = {"lang": "ko"}
    ...
    def test_아이디어탭_종목정보_ID오기입(self, api_client):
        ...
        url = api_client.get_fastapi2_url(f"/api/v2/interest/{invalid_interest_id}/price")
        params = {"lang": "ko"}
    ...
    def test_아이디어탭_뉴스_ID정상기입(self, api_client):
        ...
        # Given: 인증된 API 클라이언트와 유효한 ID
        interest_id = 123  # 예시 관심종목 ID (포트폴리오용 샘플 데이터)
        url = api_client.get_fastapi2_url(f"/api/v2/interest/news/{interest_id}")
        params = {
            "lang": "ko",
            "page": 1,
            "size": 10
    ...
    def test_아이디어탭_뉴스_ID오기입(self, api_client):
        ...
        # Given: 인증된 API 클라이언트와 존재하지 않는 ID
        invalid_interest_id = 99999
        url = api_client.get_fastapi2_url(f"/api/v2/interest/news/{invalid_interest_id}")
